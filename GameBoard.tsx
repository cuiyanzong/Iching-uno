  ...
  return (
    <div className="h-screen text-white overflow-hidden relative hexagram-bg">
      ...
      <div className="h-screen flex items-center justify-center p-6 relative z-10">
        ...
        <div className="flex-1 max-w-lg mx-8 -mt-16">
          ...
          <div className="flex flex-col items-center space-y-2 md:space-y-3">
            ...
            <Button
              ...
              className="bg-blue-600 hover:bg-blue-700 px-6 md:px-8 py-2 md:py-3 text-base md:text-lg"
            >
        ...
        <div className="absolute bottom-16 md:bottom-6 left-1/2 transform -translate-x-1/2 w-full max-w-4xl px-4 md:px-6">
          {userPlayer && (
            <>
              <PlayerArea
                player={userPlayer}
